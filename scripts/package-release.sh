...
REPO="${BUBBLEHUB_REPO:-bubblehub-labs/bubblehub-runtime}"
...
Priority: optional
Architecture: amd64
Maintainer: BubbleHub <hello@bubblehub-labs.com>
...
EOF
  ...
  cp "$pkg_root/opt/bubblehub/share/bubblehub/app/icons/bubblehub-icon.png" "$pkg_root/usr/share/icons/hicolor/512x512/apps/bubblehub-control-center.png"
