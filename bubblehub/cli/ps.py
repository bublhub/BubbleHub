...
from bubblehub.app.agents import enrich_agent_view, stop_agent
...
def command(
    ...
    if is_sandboxed():
        raise typer.BadParameter("bubblehub ps is only available to the real host user, not from inside an BubbleHub sandbox")
