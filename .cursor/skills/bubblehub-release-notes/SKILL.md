...
- Prefer short `bubblehub.dev` download links in release notes:
  - Latest asset base: `https://bubblehub.dev/download/latest`
  - Version asset base: `https://bubblehub.dev/download/<tag>`
  - Linux installer: `https://bubblehub.dev/install.sh`
  - Windows installer: `https://bubblehub.dev/install.ps1`
