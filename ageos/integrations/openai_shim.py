...
class _Completions:
    ...
    def create(self, model: str, messages: list[dict[str, str]], **kwargs: Any) -> AgeosChatCompletion:
        del model
        ...
        return AgeosChatCompletion(choices=[_Choice(message=_Message(content=content))])
